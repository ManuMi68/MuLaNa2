...
# 3) Different CA1 cells display distinct context sensitivity
...
That is, the absolute ratio of increase of Y at a given X is not constant, but depends on the attained value of Y: $\displaystyle \frac{\partial Y}{\partial X} = c(a-Y)$.  
And, for the relative rate of increase of Y, we see that: $\displaystyle \frac{\partial Y}{\partial X} \frac{1}{Y} = c\frac{(a-Y)}{Y}$.  
