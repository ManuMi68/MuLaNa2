...
### Fig.S9) Properties of FI and FS cells {Design 2 CellTye x 3 Day}
...
### Fig.S16) Differences in firing rate within and across context in FI and FS cells
...
![Figure S16A (see `Grp.S16A` code to generate this image)](images/FigS16A.png){width="400"}

```{r FS16,  warning=FALSE, message=FALSE, out.width="800px", out.height="600px", collapse=FALSE}
  if(!exists('FxDir')) source(gzcon(url("https://github.com/ManuMi68/MuLaNa2/raw/main/SupportNeuroSpatial.R")))
  NmRoo = paste0(DirPath,"/", "Fig7")
  Mk.dir(NmRoo)
...
# Box Plot
  ...
  Grp.S16A <- Grp.S16A + facet_grid( ~ CellType)
  ggsave(paste0(NmRoo,"/FigS16A.pdf"), Grp.S16A, width=14, height=10)
...
# B) AOV & Pos Hoc, with Effect Sizes
  ...
  # Results
    ...
    # cat("Graphics have been preloaded to avoid page overload\n (see the corresponding section for details).:\n");
    cat("Exploratory Analysis:\n")
    cat("Run Grp.S16A") # Exploratory Analysis
    #Grp.S16A
    cat("\n")
