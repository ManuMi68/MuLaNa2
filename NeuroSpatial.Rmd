...
{Design: (3 Day x S)} One-sample test of chance level, on each of the 3 days
...
Robust ANOVA from Wilcox functions: *`t2way`* for Omnibus, and Pos Hoc Simple effect -Direction Day on each TypeCell- with *`yuenv2`*, and Rom vs Benjamini & Hochberg (BH) Pos Hoc corrections.
...
{Design (2 CellType x S) x (3 Day x S) } One-sample test of chance level, on each of the 3\*2 Days & CellType
...
{Design (2 CellType x S) x (3 Day x S)} One-sample test of chance level, on each of the 3\*2 Days & CellType in two dependent variables (Context Prediction, Heading Prediction)
