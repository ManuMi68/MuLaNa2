...
```{r setup, include=FALSE}
 ...
 knitr::opts_chunk$set(echo = TRUE,comment = "",error=FALSE, warning = FALSE, message = FALSE, fig.show='hold',results='hold', collapse = TRUE, optipng='-o7', out.width="60%")
```
...
![Figure 1D (see `Grp.1D` code to generate this image)](images/Fig1D.png){width="200"}
...
![Figure 1E (see `Grp.1E` code to generate this image)](images/Fig1E.png){width="200"}
...
![Figure 1F (see `Res.50$GrpDay$All` code to generate this image)](images/Fig1F.png){width="200"}
...
![Figure 1G (see `Res.25.NoCx$GrpDay` code to generate this image)](images/Fig1G.png){width="200"}
...
![Figure 2C-Left (see \`Grp.2CL\` code to generate this image)](images/Fig2CLeft.png){width="200"}
...
![Figure 2C-Rght (see \`Grp.2CR\` code to generate this image)](images/Fig2CRight.png){width="200"}
...
![Figure 3C (see F3C code chunk to generate this image)](images/Fig3C.png){width="4.13in"}
...
![Figure S4A (see Grp.S4A code to generate this image)](images/FigS4A.png){width="404"}

```{r FS4A, out.width="1000px",out.height="600px"}
  if(!exists('FxDir')) source(gzcon(url("https://github.com/ManuMi68/MuLaNa2/raw/main/SupportNeuroSpatial.R")))
...
![Figure S4B (see `AdjMod.23.f` code to generate this image)](images/FigS4B.png){width="259"}
...
![Figure S7 (see `Grp.S7` code to generate this image)](images/FigS7.png){width="200"}
...
![Figure S8 (see `Grp.S8` code to generate this image)](images/FigS8.png){width="185"}
...
![Figure S9 (see `Grp.S9` code to generate this image)](images/FigS9.png){width="185"}

```{r FS9, warning=FALSE, message=FALSE, out.width="1000px", out.height="800px"}
  if(!exists('FxDir')) source(gzcon(url("https://github.com/ManuMi68/MuLaNa2/raw/main/SupportNeuroSpatial.R")))
  NmRoo = paste0(DirPath,"/", "FigS8_S9_TableS5 for Fig3")
  Mk.dir(NmRoo)
  DTp<-copy(CalciumStabilityPerCell)
...
![Figure 4B (see `Grp.4B` code to generate this image)](images/Fig4B.png){width="249"}
